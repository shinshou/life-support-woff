...
var SHEET_DEFINITIONS = [
  {
    name: 'プロジェクト',
    headers: ['project_id', 'project_name', 'project_type', 'start_date', 'updated_at'],
    headerColor: '#1565c0',
    colWidths: [200, 240, 120, 120, 180]
  },
  {
    name: 'タスク',
    headers: ['task_id', 'project_id', 'default_task_id', 'task_name', 'assignee', 'start_date', 'due_date', 'status', 'comment', 'updated_at'],
    headerColor: '#2e7d32',
    colWidths: [200, 200, 200, 200, 120, 120, 120, 80, 240, 180]
  },
  {
    name: 'デフォルトタスク',
