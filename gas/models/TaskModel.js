...
var TaskModel = (function () {
  ...
  function update(taskId, data) {
    ...
    SpreadsheetUtil.updateRowById(SpreadsheetUtil.getSheet(SHEET), 'task_id', taskId, data, data.updated_at);
  }

  function deleteById(taskId) {
    SpreadsheetUtil.deleteRowById(SpreadsheetUtil.getSheet(SHEET), 'task_id', taskId);
  }
