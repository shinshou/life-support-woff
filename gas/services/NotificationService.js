...
var NotificationService = (function () {
  ...
  function _getAccessToken() {
    // CacheService でトークンをキャッシュ（有効期限は1時間、余裕を持って3500秒）
    ...
    var accessToken = JSON.parse(res.getContentText()).access_token;
    if (accessToken) cache.put('lw_access_token', accessToken, 3500);
    return accessToken;
  }
